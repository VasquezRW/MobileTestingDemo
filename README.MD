...
```sh
    java -jar grid/selenium-server-4.33.0.jar node --config grid/node1.toml
    java -jar grid/selenium-server-4.33.0.jar node --config grid/node2.toml
```
